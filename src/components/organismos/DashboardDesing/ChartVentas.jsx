        ...
        <Container>
                ...
                <Change>
                    <Percentage>
                        <Icon 
                            ...
                            height="26"
                            icon={
                            isNeutral ? "akar-icons:minus"
                            : isPositive ? "iconamoon:arrow-up-2-fill" 
            ...
            <ResponsiveContainer width="100%" height={200}>
                ...
                >
                    ...
                    <Area strokeWidth={6} type="monotone" dataKey="uv" stroke={themeStyle.text} fill="url(#colorValue)" activeDot={{r: 6}} fillOpacity={1} />
                </AreaChart>
                </ResponsiveContainer>
