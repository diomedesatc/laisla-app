...
export const  SelectAlmacenModal = () => {
    ...
    const {almacenItemSelect,setAlmacenItemSelect} = useAlmacenesStore();
    ...
    const {setStateModal, dataStockXAlmacenesXProducto: data} = useStockStore();
    ...
    async function insertarDVentas(idventa){
        ...
        const dVentas = {
            ...
            _id_almacen: almacenItemSelect?.id_almacen
