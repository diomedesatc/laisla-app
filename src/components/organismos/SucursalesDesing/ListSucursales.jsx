                                        ...
                                        return(
                                            <CajaItem key={index}>
                                                ...
                                                <Acciones $right="10px" $bottom="10px">
                                                    {
                                                        caja.delete && 
                                                    <Icon icon="wpf:delete" width="15" height="15" className="deleteicon" onClick={() => doDeleteCaja(caja?.id)}/>
                                                    }
                                                    <Icon icon="mdi:edit" width="20" height="20" onClick={() => editarCaja(caja)}/>
                                                </Acciones>
