...
export const BasicosConfig = () => {
  ...
  const {mutate: doEditar, isPending} = useMutation({
    ...
    mutationFn: Editar,
    onError: (e) =>{
      toast.error("Ocurrio un error guardando la informacion " + e.message)
    },
    onSuccess: () =>{
  ...
  const llamadoafuncioneditar = (data) => doEditar(data);
    ...
    <Container>
      ...
      <Avatar>
        ...
        {fileurl != "-" ? (
          ...
          <AvatarImage
            src="https://zimbronapps.com/wp-content/uploads/2019/06/tipos-de-empresa-1.jpg"
            alt="Avatar"
          />
        )}
