...
import { InputText, Btn1, useSucursalesStore, ConvertirCapitalize, useEmpresaStore } from "../../../index";
import { useForm } from "react-hook-form";
import { BtnClose } from "../../ui/buttons/BtnClose";
import { useMutation, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
export function RegistrarSucursal() {
  const { accion, sucursalesItemSelect, setStateSucursal, insertarSucursal, editarSucursal } =
    useSucursalesStore();
